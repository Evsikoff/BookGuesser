...
const App: React.FC = () => {
  ...
  const handleSelect = (book: Book) => {
    ...
    const isCorrect = book.title === currentQuestion.correctBook.title;
  ...
  const isSelected = (book: Book) => selectedBook?.title === book.title;
  const isCorrect = (book: Book) => currentQuestion?.correctBook.title === book.title;
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-md border-t border-stone-200 flex flex-col items-center animate-slide-up z-50">
               <div className="max-w-4xl w-full flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    {selectedBook?.title === currentQuestion.correctBook.title ? (
